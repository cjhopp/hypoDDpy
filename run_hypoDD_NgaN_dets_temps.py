...
cat_files_N = [
    '/Volumes/GeoPhysics_07/users-data/hoppche/catalogs/qml/year_long/hypoDD/det_cat_mcc0.5_shift0.2_NGAN_HypoDD_cc0.7_newlocs.xml',
...
hypodd_sets = {
    ...
    'iters' : ["   5  0.10  -999    2    1   1.0  -999    2    1    70",
               "   5  0.30  -999    2    1   0.7  -999    2    1    50",
               "   5  0.50  -999    2    1  0.50  -999    2    1    30",
               "   5  0.70  -999    2  0.75 0.30  -999    2 0.75    30",
               "   5  1.00  -999    2  0.5  0.01  -999    2  0.5    20"]
            }
