...
cat_file = '/Volumes/GeoPhysics_07/users-data/hoppche/detections/12-15/Catalog_Rot_ALL_final_mags_spicks_w_manual_NLLoc_vpvs_186.xml'
out_dir = '/Volumes/GeoPhysics_07/users-data/hoppche/hypoDD/all_dets_Rot_w_manual_for_GC_1sec_for_GC_vpvs_186'
out_file = 'Catalog_Rot_ALL_dets_FINAL_1sec_0.6_for_GC_vpvs_186.xml'
work_dir = out_dir
