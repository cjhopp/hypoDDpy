...
cat_file = '/Volumes/GeoPhysics_07/users-data/hoppche/detections/12-15/Catalog_Nga_ALL_dets_FINAL_24-4-18_ids_dd_mags_noSORA.xml'
out_dir = '/Volumes/GeoPhysics_07/users-data/hoppche/hypoDD/all_dets_Nga_w_manual_rewt_FINAL_noSORA'
out_file = 'Catalog_Nga_ALL_dets_FINAL_noSORA.xml'
work_dir = out_dir
...
hypodd_sets = {
    ...
    'iters' : ["   6  0.50  0.25    3    2   0.7    0.45    2    2   250",
