...
cat_file = '/Volumes/GeoPhysics_07/users-data/hoppche/detections/12-15/Catalog_Nga_ALL_final_mags_spicks_located.xml'
...
hypodd_sets = {
    ...
    'iters' : ["   5  0.30  0.15    3    2   0.7   0.35    3    2   150",
               "   5  0.30  0.15    3    1   0.7   0.35    3    1   150",
               "   5  0.50  0.25    3    1  0.50   0.25    3    1   100",
               "   5  0.70  0.35    2  0.85 0.30   0.15    2  0.85   50",
               "   5  1.00  0.50    2  0.75 0.01   0.01    2  0.75   50"]
            }
