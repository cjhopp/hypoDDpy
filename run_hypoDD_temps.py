...
cat_file = '/Volumes/GeoPhysics_07/users-data/hoppche/catalogs/qml/year_long/rotnga_obspyck_revised_withmags_12-15.xml'
...
# working dir
work_dir = '/Volumes/GeoPhysics_07/users-data/hoppche/hypoDD/all_templates'

# output dir and catalog file
out_dir = work_dir
out_file = 'det_cat_mcc0.5_shift0.2_ALL_TEMPS_HypoDD.xml'
