...
out_dir = '/Volumes/GeoPhysics_07/users-data/hoppche/hypoDD/all_dets_Nga_w_manual_rewt_FINAL_noSORA_stims_manual_for_GC'
out_file = 'Catalog_Nga_ALL_dets_FINAL_noSORA_stims_manual_rewt_for_GC.xml'
work_dir = out_dir
