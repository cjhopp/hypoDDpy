...
cat_file = '/Users/home/hoppche/data/GNS_manual_picks_08-13/manpicksGNS_rotokawa_12-13_w_NLLoc_Steve_model.xml'
out_dir = '/Volumes/GeoPhysics_07/users-data/hoppche/hypoDD/GNS_Rot_manual_for_GC'
out_file = 'Catalog_Rot_GNS_manual_1sec_0.6_for_GC.xml'
work_dir = out_dir
...
if (os.path.isfile('{}/working_files/waveform_information.json'.format(out_dir))):
    ...
    data_dir_list = glob('/Volumes/GeoPhysics_07/users-data/hoppche/stefan_sac/GNS_12-13_manual_SAC/*')
    data_file_list = []
    for dir in data_dir_list:
        data_file_list.extend(glob('{}/*'.format(dir)))
