...
cat_file = '/Volumes/GeoPhysics_07/users-data/hoppche/catalogs/qml/testing/NgaS_NM10_stimulation_templates.xml'
...
out_dir = work_dir
out_file = 'det_cat_mcc0.5_shift0.3_testing_HypoDD.xml'
